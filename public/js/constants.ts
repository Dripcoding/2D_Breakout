...
// modals
export const aboutModalLink =
	document.querySelector<HTMLAnchorElement>('#aboutModalLink')
export const controlsModalLink =
	document.querySelector<HTMLAnchorElement>('#controlsModalLink')
export const gameModeSelect =
	document.querySelector<HTMLSelectElement>('#gameModeSelect')
export const settingsModalLink =
	document.querySelector<HTMLAnchorElement>('#settingsModalLink')
export const gameEndModalTitle =
	document.querySelector<HTMLDivElement>('#gameEndModalTitle')
export const gameEndModalBody =
	document.querySelector<HTMLDivElement>('#gameEndModalBody')
...
// theme inputs
export const pastelOneRadio =
	document.querySelector<HTMLInputElement>('#pastelOneRadio')
export const pastelTwoRadio =
	document.querySelector<HTMLInputElement>('#pastelTwoRadio')
export const pastelThreeRadio =
	document.querySelector<HTMLInputElement>('#pastelThreeRadio')
export const pastelDefaultRadio = document.querySelector<HTMLInputElement>(
	'#pastelDefaultRadio'
)

export const ballColorSelect =
	document.querySelector<HTMLSelectElement>('#ballColorSelect')

export const paddleColorSelect =
	document.querySelector<HTMLSelectElement>('#paddleColorSelect')

export const brickColorSelect =
	document.querySelector<HTMLSelectElement>('#brickColorSelect')
